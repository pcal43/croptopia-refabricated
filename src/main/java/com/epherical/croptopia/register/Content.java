...
public class Content {
    ...
    public static void registerBlocks(RegisterFunction<Block> register) {
        ...
        SALT_ORE_BLOCK = register.register(createIdentifier(BlockNames.SALT_ORE), id ->new Block(BlockBehaviour.Properties.of().setId(ResourceKey.create(Registries.BLOCK, id)).mapColor(MapColor.SAND).strength(0.5F).sound(SoundType.SAND)));
    }
    ...
    public static void registerItems(RegisterFunction<Item> register) {
        ...
        PAPRIKA = register.register(createIdentifier(ItemNamesV2.PAPRIKA), id -> new Item(createGroup(id)));
        SALT = register.register(createIdentifier(ItemNamesV2.SALT), id -> new Item(createGroup(id)));
        OLIVE_OIL = register.register(createIdentifier(ItemNamesV2.OLIVE_OIL), id -> new Item(createGroup(id)));
        CHEESE = register.register(createIdentifier(ItemNamesV2.CHEESE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_3))));
        FLOUR = register.register(createIdentifier(ItemNamesV2.FLOUR), id -> new Item(createGroup(id)));
        BUTTER = register.register(createIdentifier(ItemNamesV2.BUTTER), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_3))));
        NOODLE = register.register(createIdentifier(ItemNamesV2.NOODLE), id -> new Item(createGroup(id)));
        TOFU = register.register(createIdentifier(ItemNamesV2.TOFU), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        CHOCOLATE = register.register(createIdentifier(ItemNamesV2.CHOCOLATE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        TORTILLA = register.register(createIdentifier(ItemNamesV2.TORTILLA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        SOY_SAUCE = register.register(createIdentifier(ItemNamesV2.SOY_SAUCE), id -> new Item(createGroup(id)));
        DOUGH = register.register(createIdentifier(ItemNamesV2.DOUGH), id -> new Item(createGroup(id)));
        RAVIOLI = register.register(createIdentifier(ItemNamesV2.RAVIOLI), id -> new Item(createGroup(id)));
        SALSA = register.register(createIdentifier(ItemNamesV2.SALSA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        ARTICHOKE_DIP = register.register(createIdentifier(ItemNamesV2.ARTICHOKE_DIP), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        PEPPERONI = register.register(createIdentifier(ItemNamesV2.PEPPERONI), id -> new Item(createGroup(id).food(FoodConstructor.createBuilder(REG_5).build())));
        COFFEE = register.register(createIdentifier(ItemNamesV2.COFFEE), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_5).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        LEMONADE = register.register(createIdentifier(ItemNamesV2.LEMONADE), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_5).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        LIMEADE = register.register(createIdentifier(ItemNamesV2.LIMEADE), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_5).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        SOY_MILK = register.register(createIdentifier(ItemNamesV2.SOY_MILK), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_5).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        KALE_SMOOTHIE = register.register(createIdentifier(ItemNamesV2.KALE_SMOOTHIE), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_14).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        FRUIT_SMOOTHIE = register.register(createIdentifier(ItemNamesV2.FRUIT_SMOOTHIE), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        CHOCOLATE_MILKSHAKE = register.register(createIdentifier(ItemNamesV2.CHOCOLATE_MILKSHAKE), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        BEER = register.register(createIdentifier(ItemNamesV2.BEER), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        WINE = register.register(createIdentifier(ItemNamesV2.WINE), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        MEAD = register.register(createIdentifier(ItemNamesV2.MEAD), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        RUM = register.register(createIdentifier(ItemNamesV2.RUM), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_7).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        PUMPKIN_SPICE_LATTE = register.register(createIdentifier(ItemNamesV2.PUMPKIN_SPICE_LATTE), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_14).alwaysEdible().build())));
        BEEF_JERKY = register.register(createIdentifier(ItemNamesV2.BEEF_JERKY), id -> new Item(createGroup(id).food(FoodConstructor.createBuilder(REG_5).build())));
        PORK_JERKY = register.register(createIdentifier(ItemNamesV2.PORK_JERKY), id -> new Item(createGroup(id).food(FoodConstructor.createBuilder(REG_5).build())));
        KALE_CHIPS = register.register(createIdentifier(ItemNamesV2.KALE_CHIPS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        POTATO_CHIPS = register.register(createIdentifier(ItemNamesV2.POTATO_CHIPS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        STEAMED_RICE = register.register(createIdentifier(ItemNamesV2.STEAMED_RICE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        FRENCH_FRIES = register.register(createIdentifier(ItemNamesV2.FRENCH_FRIES), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        SWEET_POTATO_FRIES = register.register(createIdentifier(ItemNamesV2.SWEET_POTATO_FRIES), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        ONION_RINGS = register.register(createIdentifier(ItemNamesV2.ONION_RINGS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        DOUGHNUT = register.register(createIdentifier(ItemNamesV2.DOUGHNUT), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        CUCUMBER_SALAD = register.register(createIdentifier(ItemNamesV2.CUCUMBER_SALAD), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CAESAR_SALAD = register.register(createIdentifier(ItemNamesV2.CAESAR_SALAD), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        LEAFY_SALAD = register.register(createIdentifier(ItemNamesV2.LEAFY_SALAD), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        FRUIT_SALAD = register.register(createIdentifier(ItemNamesV2.FRUIT_SALAD), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        VEGGIE_SALAD = register.register(createIdentifier(ItemNamesV2.VEGGIE_SALAD), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        PORK_AND_BEANS = register.register(createIdentifier(ItemNamesV2.PORK_AND_BEANS), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        OATMEAL = register.register(createIdentifier(ItemNamesV2.OATMEAL), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        LEEK_SOUP = register.register(createIdentifier(ItemNamesV2.LEEK_SOUP), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        YOGHURT = register.register(createIdentifier(ItemNamesV2.YOGHURT), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        SAUCY_CHIPS = register.register(createIdentifier(ItemNamesV2.SAUCY_CHIPS), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        ROASTED_NUTS = register.register(createIdentifier(ItemNamesV2.ROASTED_NUTS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        TRAIL_MIX = register.register(createIdentifier(ItemNamesV2.TRAIL_MIX), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        PROTEIN_BAR = register.register(createIdentifier(ItemNamesV2.PROTEIN_BAR), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        NOUGAT = register.register(createIdentifier(ItemNamesV2.NOUGAT), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        SCRAMBLED_EGGS = register.register(createIdentifier(ItemNamesV2.SCRAMBLED_EGGS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        BUTTERED_TOAST = register.register(createIdentifier(ItemNamesV2.BUTTERED_TOAST), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_9))));
        TOAST_WITH_JAM = register.register(createIdentifier(ItemNamesV2.TOAST_WITH_JAM), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_9))));
        HAM_SANDWICH = register.register(createIdentifier(ItemNamesV2.HAM_SANDWICH), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        PEANUT_BUTTER_AND_JAM = register.register(createIdentifier(ItemNamesV2.PEANUT_BUTTER_AND_JAM), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        BLT = register.register(createIdentifier(ItemNamesV2.BLT), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        GRILLED_CHEESE = register.register(createIdentifier(ItemNamesV2.GRILLED_CHEESE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        TUNA_SANDWICH = register.register(createIdentifier(ItemNamesV2.TUNA_SANDWICH), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CHEESEBURGER = register.register(createIdentifier(ItemNamesV2.CHEESEBURGER), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        HAMBURGER = register.register(createIdentifier(ItemNamesV2.HAMBURGER), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        TOFUBURGER = register.register(createIdentifier(ItemNamesV2.TOFUBURGER), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        PIZZA = register.register(createIdentifier(ItemNamesV2.PIZZA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        SUPREME_PIZZA = register.register(createIdentifier(ItemNamesV2.SUPREME_PIZZA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_18))));
        CHEESE_PIZZA = register.register(createIdentifier(ItemNamesV2.CHEESE_PIZZA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        PINEAPPLE_PEPPERONI_PIZZA = register.register(createIdentifier(ItemNamesV2.PINEAPPLE_PEPPERONI_PIZZA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_18))));
        LEMON_CHICKEN = register.register(createIdentifier(ItemNamesV2.LEMON_CHICKEN), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        FRIED_CHICKEN = register.register(createIdentifier(ItemNamesV2.FRIED_CHICKEN), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CHICKEN_AND_NOODLES = register.register(createIdentifier(ItemNamesV2.CHICKEN_AND_NOODLES), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CHICKEN_AND_DUMPLINGS = register.register(createIdentifier(ItemNamesV2.CHICKEN_AND_DUMPLINGS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        TOFU_AND_DUMPLINGS = register.register(createIdentifier(ItemNamesV2.TOFU_AND_DUMPLINGS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        SPAGHETTI_SQUASH = register.register(createIdentifier(ItemNamesV2.SPAGHETTI_SQUASH), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CHICKEN_AND_RICE = register.register(createIdentifier(ItemNamesV2.CHICKEN_AND_RICE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        TACO = register.register(createIdentifier(ItemNamesV2.TACO), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        SUSHI = register.register(createIdentifier(ItemNamesV2.SUSHI), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        EGG_ROLL = register.register(createIdentifier(ItemNamesV2.EGG_ROLL), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CASHEW_CHICKEN = register.register(createIdentifier(ItemNamesV2.CASHEW_CHICKEN), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        YAM_JAM = register.register(createIdentifier(ItemNamesV2.YAM_JAM), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        BANANA_CREAM_PIE = register.register(createIdentifier(ItemNamesV2.BANANA_CREAM_PIE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        CANDY_CORN = register.register(createIdentifier(ItemNamesV2.CANDY_CORN), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        RUM_RAISIN_ICE_CREAM = register.register(createIdentifier(ItemNamesV2.RUM_RAISIN_ICE_CREAM), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        CHEESE_CAKE = register.register(createIdentifier(ItemNamesV2.CHEESE_CAKE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        BROWNIES = register.register(createIdentifier(ItemNamesV2.BROWNIES), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        SNICKER_DOODLE = register.register(createIdentifier(ItemNamesV2.SNICKER_DOODLE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        BANANA_NUT_BREAD = register.register(createIdentifier(ItemNamesV2.BANANA_NUT_BREAD), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CANDIED_NUTS = register.register(createIdentifier(ItemNamesV2.CANDIED_NUTS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        ALMOND_BRITTLE = register.register(createIdentifier(ItemNamesV2.ALMOND_BRITTLE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        OATMEAL_COOKIE = register.register(createIdentifier(ItemNamesV2.RAISIN_OATMEAL_COOKIE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        NUTTY_COOKIE = register.register(createIdentifier(ItemNamesV2.NUTTY_COOKIE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        BURRITO = register.register(createIdentifier(ItemNamesV2.BURRITO), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        TOSTADA = register.register(createIdentifier(ItemNamesV2.TOSTADA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        HORCHATA = register.register(createIdentifier(ItemNamesV2.HORCHATA), id -> new Drink(createGroup(id).food(FoodConstructor.createFood(REG_10), Consumables.DEFAULT_DRINK)));
        CARNITAS = register.register(createIdentifier(ItemNamesV2.CARNITAS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        FAJITAS = register.register(createIdentifier(ItemNamesV2.FAJITAS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        ENCHILADA = register.register(createIdentifier(ItemNamesV2.ENCHILADA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CHURROS = register.register(createIdentifier(ItemNamesV2.CHURROS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        TAMALES = register.register(createIdentifier(ItemNamesV2.TAMALES), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        TRES_LECHE_CAKE = register.register(createIdentifier(ItemNamesV2.TRES_LECHE_CAKE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_18))));
        STUFFED_POBLANOS = register.register(createIdentifier(ItemNamesV2.STUFFED_POBLANOS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        CHILI_RELLENO = register.register(createIdentifier(ItemNamesV2.CHILI_RELLENO), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        CREMA = register.register(createIdentifier(ItemNamesV2.CREMA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_3))));
        REFRIED_BEANS = register.register(createIdentifier(ItemNamesV2.REFRIED_BEANS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        CHIMICHANGA = register.register(createIdentifier(ItemNamesV2.CHIMICHANGA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        QUESADILLA = register.register(createIdentifier(ItemNamesV2.QUESADILLA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CORN_HUSK = register.register(createIdentifier(ItemNamesV2.CORN_HUSK), id -> new Item(createGroup(id)));
        WHIPPING_CREAM = register.register(createIdentifier(ItemNamesV2.WHIPPING_CREAM), id -> new Item(createGroup(id)));
        SHEPHERDS_PIE = register.register(createIdentifier(ItemNamesV2.SHEPHERDS_PIE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_18))));
        BEEF_WELLINGTON = register.register(createIdentifier(ItemNamesV2.BEEF_WELLINGTON), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_18))));
        FISH_AND_CHIPS = register.register(createIdentifier(ItemNamesV2.FISH_AND_CHIPS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        ETON_MESS = register.register(createIdentifier(ItemNamesV2.ETON_MESS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        TEA = register.register(createIdentifier(ItemNamesV2.TEA), id -> new Drink(createGroup(id).food(FoodConstructor.createBuilder(REG_5).alwaysEdible().build(), Consumables.DEFAULT_DRINK)));
        CORNISH_PASTY = register.register(createIdentifier(ItemNamesV2.CORNISH_PASTY), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        SCONES = register.register(createIdentifier(ItemNamesV2.SCONES), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        FIGGY_PUDDING = register.register(createIdentifier(ItemNamesV2.FIGGY_PUDDING), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        TREACLE_TART = register.register(createIdentifier(ItemNamesV2.TREACLE_TART), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        STICKY_TOFFEE_PUDDING = register.register(createIdentifier(ItemNamesV2.STICKY_TOFFEE_PUDDING), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        TRIFLE = register.register(createIdentifier(ItemNamesV2.TRIFLE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        WATER_BOTTLE = register.register(createIdentifier(ItemNamesV2.WATER_BOTTLE), id -> new Item(createGroup(id)));

        MILK_BOTTLE = register.register(createIdentifier(ItemNamesV2.MILK_BOTTLE), id -> new Item(createGroup(id)));
        AJVAR = register.register(createIdentifier(ItemNamesV2.AJVAR), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        AJVAR_TOAST = register.register(createIdentifier(ItemNamesV2.AJVAR_TOAST), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        AVOCADO_TOAST = register.register(createIdentifier(ItemNamesV2.AVOCADO_TOAST), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        BEEF_STEW = register.register(createIdentifier(ItemNamesV2.BEEF_STEW), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        BEEF_STIR_FRY = register.register(createIdentifier(ItemNamesV2.BEEF_STIR_FRY), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        BUTTERED_GREEN_BEANS = register.register(createIdentifier(ItemNamesV2.BUTTERED_GREEN_BEANS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CHEESY_ASPARAGUS = register.register(createIdentifier(ItemNamesV2.CHEESY_ASPARAGUS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CHOCOLATE_ICE_CREAM = register.register(createIdentifier(ItemNamesV2.CHOCOLATE_ICE_CREAM), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        EGGPLANT_PARMESAN = register.register(createIdentifier(ItemNamesV2.EGGPLANT_PARMESAN), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_18))));
        FRUIT_CAKE = register.register(createIdentifier(ItemNamesV2.FRUIT_CAKE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        GRILLED_EGGPLANT = register.register(createIdentifier(ItemNamesV2.GRILLED_EGGPLANT), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        KIWI_SORBET = register.register(createIdentifier(ItemNamesV2.KIWI_SORBET), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        LEMON_COCONUT_BAR = register.register(createIdentifier(ItemNamesV2.LEMON_COCONUT_BAR), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        NETHER_WART_STEW = register.register(createIdentifier(ItemNamesV2.NETHER_WART_STEW), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        PEANUT_BUTTER = register.register(createIdentifier(ItemNamesV2.PEANUT_BUTTER), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        PEANUT_BUTTER_W_CELERY = register.register(createIdentifier(ItemNamesV2.PEANUT_BUTTER_W_CELERY), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        POTATO_SOUP = register.register(createIdentifier(ItemNamesV2.POTATO_SOUP), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        RATATOUILLE = register.register(createIdentifier(ItemNamesV2.RATATOUILLE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_18))));
        RAW_BACON = register.register(createIdentifier(ItemNamesV2.RAW_BACON), id -> new Item(createGroup(id).food(FoodConstructor.createBuilder(REG_1).build())));
        RHUBARB_CRISP = register.register(createIdentifier(ItemNamesV2.RHUBARB_CRISP), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        ROASTED_ASPARAGUS = register.register(createIdentifier(ItemNamesV2.ROASTED_ASPARAGUS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        ROASTED_RADISHES = register.register(createIdentifier(ItemNamesV2.ROASTED_RADISHES), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        ROASTED_SQUASH = register.register(createIdentifier(ItemNamesV2.ROASTED_SQUASH), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        ROASTED_TURNIPS = register.register(createIdentifier(ItemNamesV2.ROASTED_TURNIPS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        STEAMED_BROCCOLI = register.register(createIdentifier(ItemNamesV2.STEAMED_BROCCOLI), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        STEAMED_GREEN_BEANS = register.register(createIdentifier(ItemNamesV2.STEAMED_GREEN_BEANS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_7))));
        STIR_FRY = register.register(createIdentifier(ItemNamesV2.STIR_FRY), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_12))));
        STUFFED_ARTICHOKE = register.register(createIdentifier(ItemNamesV2.STUFFED_ARTICHOKE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_18))));
        TOAST_SANDWICH = register.register(createIdentifier(ItemNamesV2.TOAST_SANDWICH), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        ROASTED_PUMPKIN_SEEDS = register.register(createIdentifier(ItemNamesV2.ROASTED_PUMPKIN_SEEDS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_4))));
        ROASTED_SUNFLOWER_SEEDS = register.register(createIdentifier(ItemNamesV2.ROASTED_SUNFLOWER_SEEDS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_4))));
        PUMPKIN_BARS = register.register(createIdentifier(ItemNamesV2.PUMPKIN_BARS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_6))));
        CORN_BREAD = register.register(createIdentifier(ItemNamesV2.CORN_BREAD), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        PUMPKIN_SOUP = register.register(createIdentifier(ItemNamesV2.PUMPKIN_SOUP), id -> new Soup(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        MERINGUE = register.register(createIdentifier(ItemNamesV2.MERINGUE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_6))));
        CABBAGE_ROLL = register.register(createIdentifier(ItemNamesV2.CABBAGE_ROLL), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        BORSCHT = register.register(createIdentifier(ItemNamesV2.BORSCHT), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_12))));
        GOULASH = register.register(createIdentifier(ItemNamesV2.GOULASH), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_16))));
        BEETROOT_SALAD = register.register(createIdentifier(ItemNamesV2.BEETROOT_SALAD), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CANDIED_KUMQUATS = register.register(createIdentifier(ItemNamesV2.CANDIED_KUMQUATS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_6))));
        STEAMED_CRAB = register.register(createIdentifier(ItemNamesV2.STEAMED_CRAB), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_6))));
        SEA_LETTUCE = register.register(createIdentifier(ItemNamesV2.SEA_LETTUCE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_1))));
        DEEP_FRIED_SHRIMP = register.register(createIdentifier(ItemNamesV2.DEEP_FRIED_SHRIMP), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        TUNA_ROLL = register.register(createIdentifier(ItemNamesV2.TUNA_ROLL), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        FRIED_CALAMARI = register.register(createIdentifier(ItemNamesV2.FRIED_CALAMARI), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_10))));
        CRAB_LEGS = register.register(createIdentifier(ItemNamesV2.CRAB_LEGS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_11))));
        STEAMED_CLAMS = register.register(createIdentifier(ItemNamesV2.STEAMED_CLAMS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_11))));
        GRILLED_OYSTERS = register.register(createIdentifier(ItemNamesV2.GRILLED_OYSTERS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_11))));
        ANCHOVY_PIZZA = register.register(createIdentifier(ItemNamesV2.ANCHOVY_PIZZA), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_15))));
        MASHED_POTATOES = register.register(createIdentifier(ItemNamesV2.MASHED_POTATOES), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_9))));

        BAKED_CREPES = register.register(createIdentifier(ItemNamesV2.BAKED_CREPES), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_12))));
        CINNAMON_ROLL = register.register(createIdentifier(ItemNamesV2.CINNAMON_ROLL), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_8))));
        CROQUE_MADAME = register.register(createIdentifier(ItemNamesV2.CROQUE_MADAME), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_14))));
        CROQUE_MONSIEUR = register.register(createIdentifier(ItemNamesV2.CROQUE_MONSIEUR), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_13))));
        DAUPHINE_POTATOES = register.register(createIdentifier(ItemNamesV2.DAUPHINE_POTATOES), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_12))));
        FRIED_FROG_LEGS = register.register(createIdentifier(ItemNamesV2.FRIED_FROG_LEGS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_6))));
        FROG_LEGS = register.register(createIdentifier(ItemNamesV2.FROG_LEGS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_3))));
        GROUND_PORK = register.register(createIdentifier(ItemNamesV2.GROUND_PORK), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_1))));
        HASHED_BROWN = register.register(createIdentifier(ItemNamesV2.HASHED_BROWN), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_2))));
        MACARON = register.register(createIdentifier(ItemNamesV2.MACARON), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        QUICHE = register.register(createIdentifier(ItemNamesV2.QUICHE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_12))));
        SAUSAGE = register.register(createIdentifier(ItemNamesV2.SAUSAGE), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_3))));
        SUNNY_SIDE_EGGS = register.register(createIdentifier(ItemNamesV2.SUNNY_SIDE_EGGS), id -> new Item(createGroup(id).food(FoodConstructor.createFood(REG_5))));
        ...
        SALT_ORE = register.register(createIdentifier(ItemNamesV2.SALT_ORE), id ->  new BlockItem(SALT_ORE_BLOCK, createGroup(id)));
    }
    ...
    public static <FC extends FeatureConfiguration, F extends Feature<FC>> Holder<ConfiguredFeature<FC, ?>> register(Identifier id, ConfiguredFeature<FC, F> feature) {
