...
public class CroptopiaRecipeProvider extends FabricRecipeProvider {
    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider provider, RecipeOutput recipeOutput) {
        ...
        return new RecipeProvider(provider, recipeOutput) {
            ...
            public void buildRecipes() {
                ...
                generateSeeds(this, items, recipeOutput);
                generateSaplings(this, items, recipeOutput);
                generateBarkWood(this, items, recipeOutput);
                generateJams(this, items, recipeOutput);
                generateJuices(this, items, recipeOutput);
                generateSmoothies(this, items, recipeOutput);
                generateIceCream(this, items, recipeOutput);
                generatePie(this, items, recipeOutput);
                generateFurnace(this, items, recipeOutput);
                generateUtensil(this, items, recipeOutput);
                generateMiscShapeless(this, items, recipeOutput);
                generateMiscShaped(this, items, recipeOutput);
            }
        };
    }
    ...
    protected void generateSeeds(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        for (FarmlandCrop crop : FarmlandCrop.copy()) {
            TagKey<Item> tag = independentTag(crop.getPlural());
            ShapelessRecipeBuilder.shapeless(items, MISC, crop.getSeedItem())
                    .requires(tag)
    ...
    protected void generateSaplings(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        for (TreeCrop crop : TreeCrop.copy()) {
            TagKey<Item> tag = independentTag(crop.getPlural());
            ShapelessRecipeBuilder.shapeless(items, MISC, crop.getSaplingItem())
    ...
    protected void generateBarkWood(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        for (Tree crop : Tree.copy()) {
            ShapedRecipeBuilder.shaped(items, MISC, crop.getWood())
                    .pattern("##")
                    .pattern("##")
                    .define('#', crop.getLog())
                    .unlockedBy("has_" + crop.getLowercaseName() + "_log", recipeProvider.has(crop.getLog()))
                    .save(exporter);
            ShapedRecipeBuilder.shaped(items, MISC, crop.getStrippedWood())
                    .pattern("##")
                    .pattern("##")
    ...
    protected void generateJams(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        for (Jam jam : Jam.copy()) {
            TagKey<Item> tag = independentTag(jam.getCrop().getPlural());
            ShapelessRecipeBuilder.shapeless(items, MISC, jam)
    ...
    protected void generateJuices(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        for (Juice juice : Juice.copy()) {
            TagKey<Item> tag = independentTag(juice.getCrop().getPlural());
            ShapelessRecipeBuilder.shapeless(items, MISC, juice)
    ...
    protected void generateSmoothies(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        for (Smoothie smoothie : Smoothie.copy()) {
            TagKey<Item> tag = independentTag(smoothie.getCrop().getPlural());
            ShapelessRecipeBuilder.shapeless(items, MISC, smoothie)
    ...
    protected void generateIceCream(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        for (IceCream iceCream : IceCream.copy()) {
            TagKey<Item> tag = independentTag(iceCream.getCrop().getPlural());
            ShapelessRecipeBuilder.shapeless(items, MISC, iceCream)
    ...
    protected void generatePie(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        for (Pie pie : Pie.copy()) {
            TagKey<Item> tag = independentTag(pie.getCrop().getPlural());
            ShapelessRecipeBuilder.shapeless(items, MISC, pie)
    ...
    protected void offerFoodCookingRecipe(RecipeProvider recipeProvider, RecipeOutput exporter, ItemLike input, String inputName, ItemLike output, int time, float exp, boolean campFire) {
    ...
    protected void generateFurnace(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        ...
        var cookingList = new ImmutableMap.Builder<ItemConvertibleWithPlural, ItemLike>()
                ...
                .build();
        cookingList.forEach((input, output) -> offerFoodCookingRecipe(recipeProvider, exporter, input, input.getLowercaseName(), output, time, exp, true));
        // raw bacon is not yet moved
        offerFoodCookingRecipe(recipeProvider, exporter, Content.RAW_BACON, ItemNamesV2.RAW_BACON, Content.COOKED_BACON, time, exp, true);
        // now the vanilla ingredients
        offerFoodCookingRecipe(recipeProvider, exporter, Items.SUGAR, "sugar", Content.CARAMEL, time, exp, true);
        offerFoodCookingRecipe(recipeProvider, exporter, Items.SUGAR_CANE, "sugar_cane", Content.MOLASSES, time, exp, false);
        offerFoodCookingRecipe(recipeProvider, exporter, Items.BREAD, "bread", Content.TOAST, time, exp, false);
        // only salt missing
        offerFoodCookingRecipe(recipeProvider, exporter, Content.WATER_BOTTLE, ItemNamesV2.WATER_BOTTLE, Content.SALT, 800, 0.1f, false);
    }

    protected void generateUtensil(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        ShapedRecipeBuilder.shaped(items, MISC, Content.COOKING_POT)
                .pattern("# #")
                .pattern("# #")
                .pattern(" # ")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.FOOD_PRESS)
                .pattern("I")
                .pattern("H")
                .pattern("I")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.FRYING_PAN)
                .pattern("#  ")
                .pattern(" ##")
                .pattern(" ##")
                .define('#', Items.IRON_INGOT)
                .unlockedBy("has_iron", recipeProvider.has(Items.IRON_INGOT))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.KNIFE)
                .pattern(" #")
                .pattern("i ")
                .define('i', Items.STICK).define('#', Items.IRON_INGOT)
                .unlockedBy("has_iron", recipeProvider.has(Items.IRON_INGOT))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.MORTAR_AND_PESTLE)
                .pattern("i")
                .pattern("#")
    ...
    protected void generateMiscShapeless(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        TagKey<Item> saltTag = independentTag("salts");
        ShapelessRecipeBuilder.shapeless(items, MISC, Items.DEAD_BUSH)
        ...
        ShapelessRecipeBuilder.shapeless(items, MISC, Content.CANDIED_KUMQUATS, 7)
                .requires(kumquatTag)
                .requires(kumquatTag)
                .requires(kumquatTag)
                .requires(kumquatTag)
        ...
        ShapelessRecipeBuilder.shapeless(items, MISC, Items.ORANGE_DYE, 2)
        ...
        ShapelessRecipeBuilder.shapeless(items, MISC, Items.PURPLE_DYE, 2)
                .requires(grapeTag)
                .requires(grapeTag)
                .requires(grapeTag)
    ...
    protected void generateMiscShaped(RecipeProvider recipeProvider, HolderGetter<Item> items, RecipeOutput exporter) {
        ShapedRecipeBuilder.shaped(items, MISC, Content.ROASTED_PUMPKIN_SEEDS)
                .pattern("123")
                .pattern(" 4 ")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.ROASTED_SUNFLOWER_SEEDS)
                .pattern("123")
                .pattern(" 4 ")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.PUMPKIN_BARS, 3)
                .pattern("586")
                .pattern("124")
                .pattern("373")
                .define('1', Items.EGG)
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.CORN_BREAD)
                .pattern("111")
                .define('1', independentTag("corn"))
                .unlockedBy("has_corn", recipeProvider.has(Content.CORN.asItem()))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.PUMPKIN_SOUP, 2)
                .pattern("123")
                .pattern(" 5 ")
                .pattern("464")
                ...
                .unlockedBy("has_pumpkin", recipeProvider.has(Items.PUMPKIN))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.MERINGUE, 2)
                .pattern("243")
                .pattern("111")
                .define('1', Items.EGG)
                .define('2', independentTag("salts"))
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.CABBAGE_ROLL, 2)
                .pattern("121")
                .pattern("456")
                .pattern("585")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.BORSCHT, 2)
                .pattern("123")
                .pattern("456")
                .pattern("789")
                ...
                .unlockedBy("has_cabbage", recipeProvider.has(Content.CABBAGE.asItem()))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.GOULASH)
                .pattern("123")
                .pattern("454")
                .pattern("183")
                .define('8', Content.FRYING_PAN)
                ...
                .unlockedBy("has_cabbage", recipeProvider.has(Content.CABBAGE.asItem()))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.BEETROOT_SALAD)
                .pattern("111")
                .pattern("745")
                .pattern(" 6 ")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.STEAMED_CRAB)
                .pattern("1")
                .pattern("2")
                .pattern("3")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.DEEP_FRIED_SHRIMP, 2)
                .pattern("111")
                .pattern("456")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.TUNA_ROLL, 2)
                .pattern("234")
                .pattern(" 1 ")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.FRIED_CALAMARI, 2)
                .pattern("123")
                .pattern("456")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.CRAB_LEGS, 2)
                .pattern("123")
                .pattern("455")
                .pattern(" 7 ")
                ...
                .unlockedBy("has_crab", recipeProvider.has(Content.CRAB))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.STEAMED_CLAMS, 2)
                .pattern("123")
                .pattern("455")
                .pattern(" 7 ")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.GRILLED_OYSTERS, 2)
                .pattern("121")
                .pattern("456")
                .pattern(" 7 ")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.ANCHOVY_PIZZA, 1)
                .pattern("123")
                .pattern(" 4 ")
                .pattern(" 7 ")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.MASHED_POTATOES, 1)
                .pattern("1 ")
                .pattern("24")
                .pattern("3 ")
                ...
                .save(exporter);
        ShapelessRecipeBuilder.shapeless(items, MISC, Content.TORTILLA, 2)
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.SWEET_CREPES, 1)
                .pattern("123")
                .pattern("4 5")
                .pattern(" 6 ")
                ...
                .unlockedBy("has_frying_pan", recipeProvider.has(Content.FRYING_PAN))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.BAKED_CREPES, 1)
                .pattern("121")
                .pattern("356")
                .pattern(" 7 ")
                .define('1', Items.EGG)
                ...
                .unlockedBy("has_frying_pan", recipeProvider.has(Content.FRYING_PAN))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.QUICHE, 1)
                .pattern(" 1 ")
                .pattern("234")
                .pattern("5 6")
                ...
                .unlockedBy("has_frying_pan", recipeProvider.has(Content.FRYING_PAN))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.DAUPHINE_POTATOES, 1)
                .pattern("213")
                .pattern("456")
                .define('1', Content.FRYING_PAN)
                .define('2', independentTag("water_bottles"))
                ...
                .unlockedBy("has_frying_pan", recipeProvider.has(Content.FRYING_PAN))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.CROQUE_MONSIEUR, 1)
                .pattern(" 1 ")
                .pattern(" 26")
                .pattern("435")
                .define('1', Content.FRYING_PAN)
                ...
                .unlockedBy("has_frying_pan", recipeProvider.has(Content.FRYING_PAN))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.CROQUE_MADAME, 1)
                .pattern(" 1 ")
                .pattern("726")
                .pattern("435")
                .define('1', Content.FRYING_PAN)
                ...
                .unlockedBy("has_frying_pan", recipeProvider.has(Content.FRYING_PAN))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.SUNNY_SIDE_EGGS, 2)
                .pattern("121")
                .define('2', Content.FRYING_PAN)
                .define('1', Items.EGG)
                .unlockedBy("has_frying_pan", recipeProvider.has(Content.FRYING_PAN))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.MACARON, 2)
                .pattern("122")
                .pattern("565")
                .define('1', Items.EGG)
                .define('2', Items.SUGAR)
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.THE_BIG_BREAKFAST, 1)
                .pattern("123")
                .pattern("736")
                .pattern(" 45")
                .define('7', Content.FRYING_PAN)
                ...
                .unlockedBy("has_frying_pan", recipeProvider.has(Content.FRYING_PAN))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.GROUND_PORK, 2)
                .pattern("1")
                .pattern("2")
                .define('1', croptopia("pork_replacements"))
                ...
                .unlockedBy("has_food_press", recipeProvider.has(Content.FOOD_PRESS))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.SAUSAGE, 1)
                .pattern("1")
                .pattern("2")
                .pattern("3")
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.CINNAMON_ROLL, 3)
                .pattern("123")
                .pattern("456")
                .pattern("798")
                ...
                .unlockedBy("has_frying_pan", recipeProvider.has(Content.FRYING_PAN))
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, MISC, Content.HASHED_BROWN, 4)
                .pattern("123")
                .pattern(" 4 ")
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.FOOD, Content.BEEF_JERKY, 14)
                .pattern("111")
                .pattern("121")
                .pattern("111")
                .define('1', Items.BEEF)
                ...
                .save(exporter);
        ShapedRecipeBuilder.shaped(items, RecipeCategory.FOOD, Content.PORK_JERKY, 14)
                .pattern("111")
                .pattern("121")
                .pattern("111")
